...
layer1 = Dense(128,activation="sigmoid")(inputs)
layer2 = Dense(128, activation="sigmoid")(layer1)
layer2_in = Dense(128, activation="sigmoid")(inputs)
layer2_concatted = Concatenate()([layer2_in, layer2])
layer3 = Dense(128,activation="sigmoid")(layer2_concatted)
layer3_in = Dense(128,activation="sigmoid")(inputs)
layer3_concatted = Concatenate()([layer3_in, layer3])
#layer4_prelu = PReLU()(layer3_concatted)
#layer4_in = Dense(32)(inputs)
...
with open("model_4q_16sub_128nn_sigmoid.json", "w") as json_file:
    json_file.write(model_json)
# serialize weights to HDF5
logistic_model.save_weights("model_4q_16sub_128nn_sigmoid.h5")
